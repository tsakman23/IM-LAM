...
def register_distracting_dmc_envs() -> None:
    ...
    for _domain_name, _task_name in DM_CONTROL_SUITE_ENVS:
        ...
        # Register DCS environments with distractor difficulties according to dataset https://huggingface.co/datasets/EpicPinkPenguin/visual_distracting_control_suite
