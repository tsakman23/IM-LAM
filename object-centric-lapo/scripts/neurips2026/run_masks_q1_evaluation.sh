# Run full object-centric lapo masks pipeline for Q1: does masking improve linear separability / alignment of latent actions by removing distractor content?
# Run full object-centric lapo masks pipeline with latent action dim 128 and 128k GT actions.
# Run naming: object_centric_lapo_masks_q1_<env>_seed<seed>
...
for env in "${AVAILABLE_ENVS[@]}"; do
    ...
    for seed in "${SEEDS[@]}"; do
        ...
        run_id="object_centric_lapo_masks_q1_${env//\//_}_seed${seed}"
