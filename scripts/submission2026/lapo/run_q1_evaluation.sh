# Run full lapo pipeline for Q1: does masking improve linear separability / alignment of latent actions by removing distractor content?
# Run full lapo pipeline with latent action dim 128 and 128k GT actions.
# Run naming: lapo_q1_<env>_seed<seed>
...
for env in "${AVAILABLE_ENVS[@]}"; do
    ...
    for seed in "${SEEDS[@]}"; do
        ...
        python experiments/run_lapo_bc.py \
            ...
            dataset.cache_dir="${CACHE_DIR}/lapo/${env}" \
