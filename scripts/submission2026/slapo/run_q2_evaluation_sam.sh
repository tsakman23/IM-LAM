...
# Run naming: slapo_q2_sam_<env>_action_count<action_count>_seed<seed>
# Stage 2 checkpoint naming: "./checkpoints/slapo_q1_sam_<env>_seed<seed>-2"
    ...
    for i in "${!ACTION_COUNTS[@]}"; do
        ...
        for seed in "${SEEDS[@]}"; do
            ...
            python experiments/run_slapo.py \
                ...
                trainer.previous_stage_checkpoint=./checkpoints/slapo_q1_sam_${env//\//_}_seed${seed}-2
        done
    done
